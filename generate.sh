...
time perl -Ilib bin/cpan-digger --version --screen --logname version

#perl -Ilib bin/cpan-digger --releases --screen --logname releases
#perl -Ilib bin/cpan-digger --authors --screen --logname authors
...
time perl -Ilib bin/cpan-digger --recent 500 --screen --logname recent

# Repository clonings. Time is unrelated to number of projects we report about.
# ~ 1 sec
time perl -Ilib bin/cpan-digger --dashboard --screen --logname dashboard


# Download a single file from cpan.org
# ~ 7 sec
time perl -Ilib bin/cpan-digger --permissions --screen --logname permissions

# ~ 3.5 min for 500
time perl -Ilib bin/cpan-digger --cpants --limit 500 --screen --logname cpants


# ~ 30 sec for 40,000
time perl -Ilib bin/cpan-digger --coverage 40000 --screen --logname coverage

# 0.5 sec
time perl -Ilib bin/cpan-digger --meta --screen --logname meta
...
# ~ 0.4 sec
time perl -Ilib bin/cpan-digger --metavcs --screen --logname metavcs
