...
my @fields = qw(distribution version author date vcs_url vcs_name travis github_actions appveyor circleci has_ci license issues azure_pipelines gitlab_pipeline);
sub get_fields {
    return @fields;
}
